...
export default function SubmissionsUpdateForm(props) {
  const {
    id: idProp,
    submissions,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = submissionsRecord
      ? { ...initialValues, ...submissionsRecord }
      : initialValues;
  ...
  const [submissionsRecord, setSubmissionsRecord] = React.useState(submissions);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Submissions, idProp)
        : submissions;
      setSubmissionsRecord(record);
    };
    queryData();
  }, [idProp, submissions]);
  React.useEffect(resetStateValues, [submissionsRecord]);
  const validations = {
    video: [],
    text: [],
    github: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Submissions.copyOf(submissionsRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "SubmissionsUpdateForm")}
      {...rest}
    >
      <TextField
        label="Video"
